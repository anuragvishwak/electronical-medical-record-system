...
import NurseProfileUpdateForm from "./NurseProfileUpdateForm";
import { LiaAwardSolid } from "react-icons/lia";

function NurseProfileUpdateSetting() {
  const [currentUser, setcurrentUser] = useState({});
  const [gettingUser, setgettingUser] = useState([]);
  const [openingNurseProfileForm, setopeningNurseProfileForm] = useState(false);
  ...
  return (
    <div className="bg-gray-50 min-h-screen h-full">
      ...
      {openingNurseProfileForm && (
        <NurseProfileUpdateForm
          setopeningNurseProfileForm={setopeningNurseProfileForm}
...
export default NurseProfileUpdateSetting;
