...
function MainLandingPage() {
  return (
    <div className="">
      <div className="flex items-center px-4 py-2 bg-white rounded justify-between">
        ...
        <div className="flex items-center space-x-3">
          <button className="bg-[#01B49C] text-white py-1 px-3 rounded">
            See Demo
          </button>
          <button className="py-1 px-3 rounded border hover:bg-[#003441] hover:text-white border-[#003441]">
      ...
      <div className="py-20">
        <div className="text-center">
          ...
          <p className="font-bold text-8xl  mt-12 mb-5 text-[#003441]">
            <span className="text-[#01B49C]">ANU</span>med's -{" "}
            <span className="text-[#01B49C]">EMR</span>
          </p>
          <div className="flex justify-center w-full">
            <p className="text-[#01B49C] w-7/12 italic text-lg">
          ...
          <div className="flex items-center space-x-2 justify-center mt-2">
            <button className="flex items-center bg-[#01B49C] py-1 px-3 rounded text-white space-x-1">
      ...
      <div className="py-10">
        <div className="text-center">
          <p className="text-[#003441] text-5xl font-semibold">
            Everything you need
          </p>
          <p className="font-semibold text-lg text-[#01B49C] italic mt-2">
            Comprehensive features designed for modern healthcare delivery
          </p>
        </div>
        <div className="grid grid-cols-3 bg-gray-50 py-10 px-20 my-8 gap-5">
          <div className="border bg-white border-gray-300 rounded-lg shadow p-4">
            <div className="flex items-center space-x-1">
              ...
              />
              <p className="text-[#003441] text-2xl font-semibold">
                Real-time Records
              </p>
            </div>
            <p className="text-[#01B49C]  mt-2">
        ...
        <div className="bg-[#01B49C] p-14">
          <div className="text-5xl font-bold text-[#003441]">
            <p>Why Choose</p>
            <p className="mt-2">ANUmed's EMR?</p>
          </div>

          <div className="grid grid-cols-2 mt-12 gap-7">
            ...
            <div className="flex items-center  text-white space-x-2">
              <MdCheckCircleOutline size={30} />
              <div className="">
                <p className="text-xl font-semibold">Easy for Everyone</p>
                <p className="">
            ...
            <div className="flex items-center text-white space-x-2">
              <MdCheckCircleOutline size={30} />
              <div className="">
                <p className="text-xl font-semibold">Accurate & Reliable</p>
                <p className="">
            ...
            <div className="flex items-center text-white space-x-2">
              <MdCheckCircleOutline size={30} />
              <div className="">
                <p className="text-xl font-semibold">Grows with Your Clinic</p>
                <p className="">
            ...
            <div className="flex items-center text-white space-x-2">
              <MdCheckCircleOutline size={30} />
              <div className="">
                <p className="text-xl font-semibold">Always Here for You</p>
                <p className="">
        ...
        <div className="py-20">
            <p className="text-4xl text-[#003441] text-center font-semibold">Transform Your Healthcare Practice Today.</p>
            <div className="flex justify-center">
                <p className="text-[#01B49C] mt-4 text-lg">Join thousands of healthcare providers already using Anumed's to deliver better patient care</p>
            </div>
